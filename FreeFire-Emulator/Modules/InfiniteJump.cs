...
{
    /// <summary>
    /// Infinite Jump — 無限跳躍 + 超級跳
    /// </summary>
    internal static class InfiniteJump
    {
        public static bool Enabled = false;
        public static float JumpHeight = 2.0f; // 跳躍高度倍率 (1.0-5.0)
        ...
        private static readonly byte[] Search = new byte[]
        {
            ...
            0x00, 0x00, 0x51, 0xE3, 0x03, 0x00, 0x00, 0x0A,
        ...
        public static bool ApplyPatch(Memory mem)
        {
            ...
            Console.WriteLine($"[InfiniteJump] Applied to {c}/{FoundAddresses.Count}");
            return c > 0;
        }
        public static bool RemovePatch(Memory mem)
        {
            ...
            Console.WriteLine($"[InfiniteJump] Restored {c}/{FoundAddresses.Count}");
            return c > 0;
        }
    }
}
