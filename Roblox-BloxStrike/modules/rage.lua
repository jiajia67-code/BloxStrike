...
-- page:Label(" Ragebot ")
page:Toggle("暴力機器人", false, function(v) Flags.Ragebot = v end)
page:Slider("暴力視野", 30, 360, 180, function(v) Flags.RageFOV = v end)
page:Slider("暴力命中率", 10, 100, 85, function(v) Flags.RageHC = v end)
page:Dropdown({Name="暴力骨骼", Flag="RageBone", Options={"頭部","胸部","最近","身體","骨盆","腹部","自動"}, Default="Head"})
page:Dropdown({Name="暴力排序", Flag="RageSort", Options={"十字準星","距離","血量","威脅","傷害","隨機"}, Default="Crosshair"})
page:Toggle("暴力自動射擊", true, function(v) Flags.RageAF = v end)
page:Slider("暴力射速", 1, 50, 12, function(v) Flags.RageFR = v end)
page:Toggle("暴力雙發", false, function(v) Flags.RageDT = v end)
page:Slider("暴力雙發延遲", 1, 30, 6, function(v) Flags.RageDTD = v end)
page:Toggle("暴力三連發", false, function(v) Flags.RageTT = v end)
page:Toggle("暴力自動開鏡", false, function(v) Flags.RageAScope = v end)
page:Toggle("暴力自動蹲", false, function(v) Flags.RageACrouch = v end)
page:Toggle("暴力自動換彈", false, function(v) Flags.RageAReload = v end)
page:Toggle("暴力穿牆", true, function(v) Flags.RageWall = v end)
page:Slider("暴力穿透力", 10, 100, 70, function(v) Flags.RagePen = v end)
page:Toggle("暴力預測", true, function(v) Flags.RagePred = v end)
page:Slider("暴力預測因子", 5, 80, 35, function(v) Flags.RagePredF = v end)
page:Toggle("暴力解析器", true, function(v) Flags.RageRes = v end)
page:Slider("Rage Res Steps", 1, 8, 5, function(v) Flags.RageResS = v end)
page:Toggle("暴力僅爆頭", false, function(v) Flags.RageHead = v end)
page:Toggle("暴力身體瞄準", false, function(v) Flags.RageBody = v end)
page:Toggle("暴力四肢瞄準", false, function(v) Flags.RageLimb = v end)
page:Toggle("暴力智能身體", true, function(v) Flags.RageSmartBody = v end)
page:Slider("Rage Min Damage", 1, 100, 1, function(v) Flags.RageMinDmg = v end)
page:Toggle("暴力刀人", false, function(v) Flags.RageKnife = v end)
page:Slider("Rage Knife Range", 2, 10, 5, function(v) Flags.RageKnifeR = v end)
page:Toggle("暴力電擊槍", false, function(v) Flags.RageZeus = v end)
page:Slider("Rage Zeus Range", 5, 30, 20, function(v) Flags.RageZeusR = v end)
page:Toggle("暴力安全模式", true, function(v) Flags.RageSafe = v end)
page:Toggle("暴力血量覆蓋", false, function(v) Flags.RageHPOvr = v end)
page:Slider("Rage HP Threshold", 10, 90, 30, function(v) Flags.RageHPThresh = v end)
page:Separator()
page:Label("  Enhanced HVH ")
page:Toggle("四連發", false, function(v) Flags.RageQT = v end)
page:Toggle("多目標", false, function(v) Flags.RageMultiTarget = v end)
...
page:Toggle("多點瞄準", false, function(v) Flags.RageMP = v end)
...
page:Toggle("安全點", false, function(v) Flags.RageSP = v end)
page:Slider("SP Tolerance", 1, 50, 20, function(v) Flags.RageSPTol = v end)
page:Toggle("安全點自動停用", true, function(v) Flags.RageSPAuto = v end)
page:Label("Safe Point: Don't shoot when enemy at bad angle")
page:Separator()
page:Label(" Damage Override ")
page:Toggle("傷害覆蓋", false, function(v) Flags.RageDmgOvr = v end)
page:Slider("Override Damage", 1, 120, 1, function(v) Flags.RageDmgOvrVal = v end)
page:Dropdown({Name="覆蓋按鍵", Flag="RageDmgKey", Options={"滑鼠4","滑鼠5","左Alt","左Ctrl","Shift"}, Default="Mouse4"})
page:Label("Hold key to temporarily override min damage")
page:Separator()
page:Label(" Force Aim ")
page:Toggle("強制身體", false, function(v) Flags.RageForceBody = v end)
page:Toggle("強制爆頭", false, function(v) Flags.RageForceHead = v end)
page:Dropdown({Name="強制按鍵", Flag="RageForceKey", Options={"滑鼠4","滑鼠5","左Alt","左Ctrl","Shift"}, Default="Mouse5"})
page:Label("Force: Override bone selection with key hold")
page:Separator()
page:Label(" Auto Stop ")
page:Toggle("自動急停", false, function(v) Flags.RageAutoStop = v end)
page:Toggle("空中自動急停", false, function(v) Flags.RageAutoStopAir = v end)
...
page:Dropdown({Name="SA Bone", Flag="SABone", Options={"頭部","胸部","最近","骨盆","身體","自動"}, Default="Head"})
page:Toggle("靜瞄預測", true, function(v) Flags.SAPred = v end)
page:Slider("SA Pred Time", 5, 60, 30, function(v) Flags.SAPredT = v end)
page:Toggle("靜瞄可視檢查", false, function(v) Flags.SAVis = v end)
page:Toggle("靜瞄穿牆檢查", false, function(v) Flags.SAWall = v end)
page:Toggle("靜瞄隊友檢查", true, function(v) Flags.SATeam = v end)
page:Toggle("靜瞄自動射擊", false, function(v) Flags.SAAF = v end)
page:Slider("SA Target Switch", 0, 500, 80, function(v) Flags.SASwitch = v end)
page:Toggle("靜瞄視野圈", true, function(v) Flags.SAFovCirc = v end)
page:Slider("SA Smooth", 1, 20, 1, function(v) Flags.SASmooth = v end)
page:Toggle("靜瞄智能模式", false, function(v) Flags.SASmart = v end)
page:Slider("SA Smart Range", 10, 100, 45, function(v) Flags.SASmartR = v end)
page:Toggle("靜瞄回溯", false, function(v) Flags.SABacktrack = v end)
page:Slider("SA BT Time", 50, 400, 200, function(v) Flags.SABTT = v end)
page:Toggle("靜瞄命中音效", false, function(v) Flags.SAHitSnd = v end)
page:Label(" Advanced SA ")
page:Toggle("靜瞄多目標", false, function(v) Flags.SAMultiT = v end)
page:Slider("SA Multi Count", 1, 5, 2, function(v) Flags.SAMultiC = v end)
page:Toggle("靜瞄解析覆蓋", false, function(v) Flags.SAResOvr = v end)
page:Toggle("靜瞄命中框擴大", false, function(v) Flags.SAHBE = v end)
page:Slider("SA HB Size", 1, 5, 2, function(v) Flags.SAHBS = v end)
page:Toggle("靜瞄魔法子彈", false, function(v) Flags.SAMagic = v end)
page:Slider("SA Magic Distance", 10, 100, 50, function(v) Flags.SAMagicD = v end)
page:Toggle("靜瞄自動穿牆", true, function(v) Flags.SAAutoWall = v end)
page:Slider("SA Wallbang Pen", 10, 100, 70, function(v) Flags.SAWallPen = v end)
page:Toggle("靜瞄延遲補償", false, function(v) Flags.SALagComp = v end)
page:Slider("SA LC Ticks", 1, 16, 8, function(v) Flags.SALCTicks = v end)
page:Toggle("靜瞄位置調整", false, function(v) Flags.SAPosAdj = v end)
...
page:Toggle("靜瞄最近骨骼", false, function(v) Flags.SANBP = v end)
page:Toggle("靜瞄散布控制", false, function(v) Flags.SASpread = v end)
page:Slider("SA Spread Factor", 0, 100, 50, function(v) Flags.SASpreadF = v end)
page:Toggle("靜瞄後座控制", false, function(v) Flags.SARCS = v end)
page:Slider("SA RCS X", 0, 100, 60, function(v) Flags.SARCSX = v end)
page:Slider("SA RCS Y", 0, 100, 80, function(v) Flags.SARCSY = v end)
page:Toggle("靜瞄靜步", false, function(v) Flags.SASilentWalk = v end)
page:Toggle("靜瞄自動開鏡", false, function(v) Flags.SAAutoScope = v end)
page:Toggle("靜瞄無視覺後座", false, function(v) Flags.SANoVR = v end)
page:Label(" Backwards / 360 SA ")
page:Toggle("靜瞄向後", false, function(v) Flags.SABackwards = v end)
page:Dropdown({Name="SA Backwards Dir", Flag="SABackDir", Options={"Away","左","右","隨機","Toward"}, Default="Away"})
page:Toggle("靜瞄360模式", false, function(v) Flags.SA360 = v end)
page:Slider("SA 360 Range", 30, 360, 360, function(v) Flags.SA360Range = v end)
page:Toggle("靜瞄反瞄同步", false, function(v) Flags.SAAASync = v end)
page:Toggle("靜瞄自動朝牆", false, function(v) Flags.SAFreeStand = v end)
page:Toggle("靜瞄假蹲瞄準", false, function(v) Flags.SAFakeDuckAim = v end)
page:Toggle("靜瞄反向瞄準", false, function(v) Flags.SAInverse = v end)
...
page:Toggle("純靜瞄", false, function(v) Flags.RagePSilent = v end)
page:Dropdown({Name="瞄準模式", Flag="RagePSMode", Options={"Server Angle","Camera","Hybrid"}, Default="Server Angle"})
...
page:Toggle("純靜瞄穿牆", true, function(v) Flags.RagePSWall = v end)
page:Toggle("純靜瞄回溯", false, function(v) Flags.RagePSBT = v end)
page:Label("PSilent: Pure server-side hit without ANY camera movement")
page:Separator()
page:Label(" Rapid Fire ")
page:Toggle("快速射擊", false, function(v) Flags.RageRapid = v end)
page:Slider("Rapid Rate", 1, 50, 25, function(v) Flags.RageRapidRate = v end)
page:Dropdown({Name="快速模式", Flag="RageRapidMode", Options={"進攻","Controlled","Burst"}, Default="Controlled"})
page:Slider("Rapid Burst Count", 2, 10, 4, function(v) Flags.RageRapidBurst = v end)
page:Toggle("快速無散布", false, function(v) Flags.RageRapidNS = v end)
page:Label("Rapid Fire: Continuous fast shooting (more aggressive than DT)")

-- -- SECTION 1.5: BULLET TRACER 
-- page:Label("--- Section ---")
page:Toggle("子彈追蹤", true, function(v) Flags.BulletTracer = v end)
page:Toggle("追蹤穿牆", true, function(v) Flags.TracerWall = v end)
...
page:Toggle("追蹤撞擊點", true, function(v) Flags.TracerImpact = v end)
page:Slider("Tracer Impact Size", 3, 15, 6, function(v) Flags.TracerImpactSize = v end)
page:Toggle("追蹤穿透線", true, function(v) Flags.TracerPenLine = v end)
page:Toggle("追蹤命中標記", true, function(v) Flags.TracerHitMarker = v end)
page:Slider("Tracer Hit Marker Size", 5, 25, 12, function(v) Flags.TracerHMS = v end)
page:Toggle("追蹤擊殺計數", false, function(v) Flags.TracerKillCount = v end)
page:Label("--- BULLET TRACER SECTION END ---")

-- SECTION 2: ANTI-AIM (Enhanced)
-- page:Label(" Anti-Aim ")
page:Toggle("反瞄準", false, function(v) Flags.AA = v end)
page:Dropdown({Name="反瞄俯仰", Flag="AAPitch", Options={
    -- "Down","Up","Zero","Jitter","隨機","Fake Up","Fake Down","Lisp","Mixed","Sideways",
    -- "Emotion","Slow Jitter","Fakedown","Zero Sway"
}, Default="Down"})
page:Dropdown({Name="反瞄偏航", Flag="AAYaw", Options={
    -- "Spin","Jitter","Back","左","右","LBY Break","Edge","Fake","Switch","Slow Spin",
    -- "Fast Spin","Wide Jitter","LBY Break Fast","Random Walk","Triangle","Opposite","T-Shape"
}, Default="Spin"})
page:Slider("反瞄速度", 1, 30, 12, function(v) Flags.AASpd = v end)
page:Slider("AA Jitter Range", 10, 180, 100, function(v) Flags.AAJittR = v end)
page:Toggle("反瞄僅地面", false, function(v) Flags.AAGround = v end)
page:Toggle("反瞄射擊時", true, function(v) Flags.AAShoot = v end)
page:Toggle("假蹲", false, function(v) Flags.AAFakeDuck = v end)
page:Slider("AA Fake Duck Choke", 1, 16, 8, function(v) Flags.AAFDC = v end)
page:Toggle("反瞄自動朝牆", false, function(v) Flags.AAFree = v end)
page:Toggle("反瞄邊緣偵測", false, function(v) Flags.AAEdge = v end)
page:Toggle("反瞄下半身偏航", true, function(v) Flags.AALBY = v end)
page:Slider("AA LBY Offset", -180, 180, 120, function(v) Flags.AALBYO = v end)
page:Toggle("反瞄動畫干擾", false, function(v) Flags.AAAnimBreak = v end)
page:Dropdown({Name="反瞄動畫風格", Flag="AAAnimStyle", Options={"Flipped","Platform","傾斜","Inverse","Downside","Slide","Moonwalk","Breaker"}, Default="Flipped"})
page:Toggle("反瞄高度變化", false, function(v) Flags.AAHeight = v end)
page:Slider("AA Height Amp", 1, 10, 3, function(v) Flags.AAHeightAmp = v end)
page:Toggle("反瞄不同步", false, function(v) Flags.AADesync = v end)
page:Slider("AA Desync Range", -180, 180, 90, function(v) Flags.AADesyncR = v end)
page:Toggle("反瞄抖動刻度", false, function(v) Flags.AAJittTick = v end)
page:Slider("AA Jitter Interval", 1, 10, 3, function(v) Flags.AAJittInt = v end)
page:Toggle("反瞄手動覆蓋", false, function(v) Flags.AAManual = v end)
page:Dropdown({Name="反瞄手動方向", Flag="AAManualDir", Options={"Forward","Backward","左","右"}, Default="Backward"})
page:Toggle("反瞄身體偏航", true, function(v) Flags.AABodyYaw = v end)
page:Slider("AA Body Yaw Offset", -180, 180, 60, function(v) Flags.AABodyYawO = v end)
page:Toggle("反瞄假角度", false, function(v) Flags.AAFakeAngles = v end)
page:Toggle("反瞄慢走", false, function(v) Flags.AASlowAA = v end)
page:Toggle("空中反瞄", false, function(v) Flags.AAAirAA = v end)
page:Toggle("反瞄不同步視覺化", false, function(v) Flags.AADesyncViz = v end)
page:Label(" Advanced AA ")
page:Toggle("反瞄動態抖動", false, function(v) Flags.AADynJitt = v end)
...
page:Toggle("反瞄側面", false, function(v) Flags.AASideways = v end)
page:Toggle("反瞄向後", false, function(v) Flags.AABackwards = v end)
page:Toggle("反瞄已解析抖動", false, function(v) Flags.AAResJitt = v end)
page:Slider("AA Resolved Jitter Speed", 1, 20, 10, function(v) Flags.AAResJSpd = v end)
page:Toggle("反瞄反解析", false, function(v) Flags.AAAntiRes = v end)
page:Toggle("反瞄身體翻轉", false, function(v) Flags.AABodyFlip = v end)
page:Slider("AA Body Flip Interval", 1, 10, 5, function(v) Flags.AABodyFlipInt = v end)
page:Toggle("反瞄假延遲同步", false, function(v) Flags.AAFLSync = v end)
page:Toggle("反瞄移動操控", false, function(v) Flags.AAMoveManip = v end)
page:Slider("AA Move Manip Strength", 1, 20, 8, function(v) Flags.AAMoveStr = v end)
page:Toggle("反瞄視角操控", false, function(v) Flags.AAViewManip = v end)
page:Slider("AA View Manip Angle", 1, 180, 90, function(v) Flags.AAViewAngle = v end)
page:Toggle("反瞄反信任", false, function(v) Flags.AAAntiUntrust = v end)
page:Toggle("反瞄慢速下半身", false, function(v) Flags.AASlowLBY = v end)
page:Slider("AA Slow LBY Speed", 1, 10, 3, function(v) Flags.AASlowLBYS = v end)
page:Toggle("反瞄失敗暴力", true, function(v) Flags.AABruteMiss = v end)
...
page:Toggle("不同步", false, function(v) Flags.AADesync2 = v end)
page:Slider("Desync Range", 1, 58, 58, function(v) Flags.AADesyncR2 = v end)
page:Dropdown({Name="不同步模式", Flag="AADesyncMode", Options={"Static","Jitter","隨機","Brute","Cycle"}, Default="Static"})
page:Slider("Desync Jitter Range", 1, 58, 30, function(v) Flags.AADesyncJR = v end)
page:Toggle("不同步反轉", true, function(v) Flags.AADesyncInv = v end)
page:Dropdown({Name="反轉按鍵", Flag="AADesyncKey", Options={"滑鼠4","滑鼠5","左Alt","左Ctrl","Shift"}, Default="Mouse4"})
page:Label("Desync: Shift hitbox away from visible model")
page:Separator()
page:Label(" Emotion (CS2  AA) ")
page:Toggle("情緒反瞄", false, function(v) Flags.AAEmotion = v end)
page:Slider("Emotion Pitch", 45, 90, 45, function(v) Flags.AAEmoPitch = v end)
page:Dropdown({Name="情緒不同步", Flag="AAEmoDesync", Options={"Static","Jitter","LBY"}, Default="Static"})
...
page:Separator()
page:Label(" Lean ")
page:Toggle("傾斜", false, function(v) Flags.AALean = v end)
page:Slider("Lean Amount", 1, 58, 58, function(v) Flags.AALeanAmt = v end)
page:Dropdown({Name="傾斜方向", Flag="AALeanSide", Options={"自動","左","右","Alternating"}, Default="Auto"})
page:Label("Lean: Body lean to make hitbox harder to resolve")
page:Separator()
page:Label(" LBY Breaker ")
page:Toggle("下半身破壞器", false, function(v) Flags.AALBYBreak = v end)
...
page:Toggle("手動反瞄", false, function(v) Flags.AAManual2 = v end)
page:Dropdown({Name="左鍵", Flag="AAMLeft", Options={"滑鼠4","滑鼠5","左Alt","左Ctrl","Shift"}, Default="Mouse4"})
page:Dropdown({Name="右鍵", Flag="AAMRight", Options={"滑鼠4","滑鼠5","左Alt","左Ctrl","Shift"}, Default="Mouse5"})
page:Dropdown({Name="後退按鍵", Flag="AAMBack", Options={"滑鼠4","滑鼠5","左Alt","左Ctrl","Shift"}, Default="Left Alt"})
page:Label("Manual: Use keys to force specific AA direction")
page:Separator()
page:Label(" Auto Freestand ")
page:Toggle("自動朝牆", false, function(v) Flags.AAFreeStand = v end)
page:Slider("Freestand Range", 1, 10, 5, function(v) Flags.AAFreeR = v end)
page:Toggle("朝牆邊緣偵測", true, function(v) Flags.AAFreeEdge = v end)
...
page:Dropdown({Name="假延遲風格", Flag="FLStyle", Options={"Constant","自適應","隨機","Tick","Break Lag","Shift","進攻","Hyper","Break LC","不同步"}, Default="Adaptive"})
page:Slider("FL Tick Rate", 1, 16, 8, function(v) Flags.FLTick = v end)
page:Toggle("假延遲僅地面", false, function(v) Flags.FLGround = v end)
page:Toggle("假延遲僅移動", false, function(v) Flags.FLMoving = v end)
page:Slider("FL Variance", 0, 50, 20, function(v) Flags.FLVar = v end)
page:Toggle("假延遲假走", false, function(v) Flags.FLFakeWalk = v end)
page:Slider("FL Fake Walk Speed", 1, 16, 4, function(v) Flags.FLFWS = v end)
page:Toggle("假延遲斷線", false, function(v) Flags.FLBLC = v end)
page:Separator()

-- -- SECTION 3B: EXPLOITS (HIDESHOTS + ONSHOT + TICKBASE)
-- page:Label(" Exploits ")
page:Toggle("隱藏射擊", false, function(v) Flags.ExploitHS = v end)
page:Slider("HS Ticks", 1, 16, 8, function(v) Flags.ExploitHSTicks = v end)
page:Dropdown({Name="爆頭模式", Flag="ExploitHSMode", Options={"Tick Shift","Lag Swap","Break LC"}, Default="Tick Shift"})
page:Label("Hideshots: Prevent getting oneshotted via tickbase")
page:Separator()
page:Toggle("單發操控", false, function(v) Flags.ExploitOnshot = v end)
page:Slider("Onshot Delay", 1, 16, 6, function(v) Flags.ExploitOSDelay = v end)
page:Label("Onshot: Manipulate when shots register")
page:Separator()
page:Toggle("假蹲", false, function(v) Flags.ExploitFakeDuck = v end)
page:Slider("假蹲封包", 1, 16, 8, function(v) Flags.ExploitFDChoke = v end)
page:Label("Fake Duck: Fake crouch to change hitbox")
page:Separator()
page:Toggle("急停(按鍵)", false, function(v) Flags.ExploitQS = v end)
page:Dropdown({Name="快速切換按鍵", Flag="ExploitQSKey", Options={"滑鼠4","滑鼠5","左Alt","左Ctrl","Shift"}, Default="Mouse4"})
...
page:Dropdown({Name="解析模式", Flag="ResMode", Options={
...
page:Toggle("解析自動", true, function(v) Flags.ResAuto = v end)
page:Toggle("解析反暴力", true, function(v) Flags.ResAB = v end)
page:Toggle("解析記錄失敗", false, function(v) Flags.ResLogMiss = v end)
page:Slider("Res Manual Angle", -180, 180, 0, function(v) Flags.ResMAngle = v end)
page:Toggle("解析覆蓋", false, function(v) Flags.ResOverride = v end)
page:Label(" Advanced Resolver ")
page:Toggle("解析速度追蹤", true, function(v) Flags.ResVelTrack = v end)
page:Slider("Res Vel History", 5, 50, 20, function(v) Flags.ResVelHist = v end)
page:Toggle("解析位置追蹤", true, function(v) Flags.ResPosTrack = v end)
page:Slider("Res Pos History", 5, 30, 15, function(v) Flags.ResPosHist = v end)
page:Toggle("解析動畫分析", false, function(v) Flags.ResAnim = v end)
page:Toggle("解析延遲補償", true, function(v) Flags.ResLagComp = v end)
page:Slider("Res LC Ticks", 1, 16, 8, function(v) Flags.ResLCTicks = v end)
page:Toggle("解析暴力模式", false, function(v) Flags.ResBruteMode = v end)
page:Slider("Res Brute Steps", 2, 16, 8, function(v) Flags.ResBruteSteps = v end)
page:Toggle("解析反向", false, function(v) Flags.ResInverse = v end)
page:Toggle("解析自適應", true, function(v) Flags.ResAdaptive = v end)
page:Slider("Res Adaptive Speed", 1, 10, 5, function(v) Flags.ResAdaptSpd = v end)
page:Toggle("解析智能偵測", true, function(v) Flags.ResSmart = v end)
page:Slider("Res Smart Confidence", 10, 100, 60, function(v) Flags.ResConf = v end)
page:Toggle("解析反暴力破解", true, function(v) Flags.ResAntiBrute = v end)
page:Slider("Res Anti Brute Steps", 2, 8, 4, function(v) Flags.ResAntiSteps = v end)
page:Toggle("解析手動覆蓋", false, function(v) Flags.ResManual = v end)
page:Slider("Res Manual Angle", -180, 180, 0, function(v) Flags.ResManAngle = v end)
page:Toggle("解析身體瞄準", false, function(v) Flags.ResBodyAim = v end)
page:Toggle("解析頭部瞄準", false, function(v) Flags.ResHeadAim = v end)
page:Toggle("解析自動切換", true, function(v) Flags.ResAutoSw = v end)
page:Slider("Res Switch Speed", 1, 10, 5, function(v) Flags.ResSwSpd = v end)
page:Toggle("解析失敗偵測", true, function(v) Flags.ResMiss = v end)
page:Slider("Res Miss Threshold", 1, 10, 3, function(v) Flags.ResMissTh = v end)
page:Toggle("解析記錄", false, function(v) Flags.ResLog = v end)
...
page:Toggle("移動反瞄解析", false, function(v) Flags.ResMovingAA = v end)
page:Slider("Moving Resolve Range", 1, 58, 58, function(v) Flags.ResMovingR = v end)
page:Dropdown({Name="移動模式", Flag="ResMovingMode", Options={"Velocity Based","Position Based","Angle Based","自適應"}, Default="Velocity Based"})
page:Label("Resolve enemy AA while they are moving")
page:Separator()
page:Label(" Side Detection ")
page:Toggle("側面偵測", false, function(v) Flags.ResSideDetect = v end)
...
page:Toggle("動畫干擾偵測", false, function(v) Flags.ResAnimDetect = v end)
page:Slider("Anim Detect Sensitivity", 1, 20, 10, function(v) Flags.ResAnimSens = v end)
page:Toggle("動畫干擾反制", false, function(v) Flags.ResAnimCounter = v end)
...
page:Toggle("急停", false, function(v) Flags.QS = v end)
page:Toggle("慢走", false, function(v) Flags.SW = v end)
page:Slider("SW Speed", 1, 16, 4, function(v) Flags.SWS = v end)
page:Toggle("無碰撞", false, function(v) Flags.NoClip = v end)
page:Toggle("邊緣摩擦", false, function(v) Flags.EdgeFric = v end)
page:Toggle("自動左輪", false, function(v) Flags.AutoRev = v end)
...
page:Toggle("蹲走", false, function(v) Flags.CrouchWalk = v end)
page:Toggle("圓形旋轉", false, function(v) Flags.CircStrafe = v end)
...
page:Dropdown({Name="快速切換模式", Flag="QSMode", Options={"Knife-Primary","Knife-Zeus","Auto-Zeus","Last Weapon"}, Default="Knife-Primary"})
page:Slider("QS Delay", 10, 500, 100, function(v) Flags.QSDelay = v end)
page:Toggle("擊殺快速切換", true, function(v) Flags.QSOnKill = v end)
page:Toggle("空彈快速切換", false, function(v) Flags.QSOnEmpty = v end)
page:Separator()
page:Label(" Enhanced Zeus ")
page:Toggle("自動電擊槍", false, function(v) Flags.AutoZeus = v end)
page:Slider("Zeus Range", 3, 20, 12, function(v) Flags.ZeusRange = v end)
page:Toggle("電擊槍自動切換", false, function(v) Flags.ZeusAutoSw = v end)
page:Toggle("電擊槍隊友檢查", true, function(v) Flags.ZeusTeam = v end)
page:Toggle("電擊槍穿牆檢查", false, function(v) Flags.ZeusWall = v end)
page:Slider("Zeus Cooldown", 100, 3000, 500, function(v) Flags.ZeusCD = v end)
page:Toggle("低血量電擊槍", false, function(v) Flags.ZeusLowHP = v end)
...
page:Toggle("滑行", false, function(v) Flags.HVHSlideWalk = v end)
...
page:Toggle("像素滑行", false, function(v) Flags.HVHPixelSurf = v end)
...
page:Toggle("蹲走", false, function(v) Flags.HVHCrouchWalk = v end)
page:Toggle("邊緣摩擦蟲", false, function(v) Flags.HVHEdgeFriction = v end)
page:Toggle("自動左輪", false, function(v) Flags.HVHAutoRev = v end)
page:Toggle("自動手槍", false, function(v) Flags.HVHAutoPistol = v end)
...
-- page:Label(" ? HVH  ")
page:Toggle("HVH 超級模式", false, function(v) Flags.HVHSuper = v end)
page:Toggle("自動反瞄", false, function(v) Flags.AutoAA = v end)
page:Toggle("自動假延遲", false, function(v) Flags.AutoFL = v end)
page:Toggle("自動解析", false, function(v) Flags.AutoRes = v end)
page:Toggle("自動暴力", false, function(v) Flags.AutoRage = v end)
page:Toggle("智能暴力破解", false, function(v) Flags.SmartBrute = v end)
page:Toggle("自動切換反瞄", false, function(v) Flags.AutoSwitchAA = v end)
page:Toggle("敵方時反瞄", false, function(v) Flags.AAOnEnemy = v end)
page:Toggle("預測反瞄", false, function(v) Flags.PredAA = v end)
page:Toggle("不同步封包", false, function(v) Flags.DesyncChoke = v end)
page:Slider("Desync Choke Ticks", 1, 16, 8, function(v) Flags.DesyncChokeT = v end)
page:Toggle("延遲尖峰反瞄", false, function(v) Flags.LagSpikeAA = v end)
page:Slider("Lag Spike Interval", 1, 20, 5, function(v) Flags.LagSpikeInt = v end)
page:Toggle("雙發擊殺", false, function(v) Flags.DTKill = v end)
...
page:Label("  ")
page:Toggle("自動穿牆擊殺", false, function(v) Flags.AutoWBKill = v end)
...
page:Toggle("穿牆通知", false, function(v) Flags.AutoWBNotify = v end)
page:Toggle("一槍模式", false, function(v) Flags.OneTap = v end)
page:Toggle("跳躍偵察", false, function(v) Flags.JumpScout = v end)
page:Slider("Jump Scout Delay", 50, 500, 150, function(v) Flags.JSDelay = v end)
page:Toggle("邊緣蟲摩擦", false, function(v) Flags.EdgeBugFriction = v end)
page:Label(" HVH  ")
...
page:Button({Name="HVH 反解析器", Color=Color3.fromRGB(100,200,100)}, function()
...
page:Button({Name="HVH 暴力組合", Color=Color3.fromRGB(200,100,0)}, function()
    Flags.Ragebot = true; Flags.RageFOV = 360; Flags.RageHC = 100
    ...
    pcall(function() game:GetService("StarterGui"):SetCore("SendNotification",{Title="暴力組合",Text="Maximum rage + Wallbang!",Duration=3}) end)
end)
...
page:Button({Name="[HVH] Show Stats", Color=Color3.fromRGB(200,200,100)}, function()
    ...
    local hvhFeatures = {"暴力機器人","反瞄","FL","解析器","SilentAim","NoClip","SpeedBoost","NoSpread","NoRecoil","FakeLag","AntiAim"}
    local activeNames = {}
...
page:Toggle("自動閃身", false, function(v) Flags.AutoPeek = v end)
page:Dropdown({Name="閃身模式", Flag="AutoPeekMode", Options={"按住按鍵","切換","Smart"}, Default="Hold Key"})
...
page:Toggle("閃身晃動", false, function(v) Flags.AutoPeekJiggle = v end)
...
page:Toggle("邊緣反瞄", false, function(v) Flags.EdgeAA = v end)
page:Slider("Edge Detect Range", 5, 50, 20, function(v) Flags.EdgeAADist = v end)
page:Toggle("邊緣自動不同步", false, function(v) Flags.EdgeAutoDesync = v end)
page:Slider("Edge Desync Offset", -60, 60, 30, function(v) Flags.EdgeDesyncOff = v end)
page:Toggle("邊緣朝牆", false, function(v) Flags.EdgeFreestand = v end)

-- SECTION 11: DAMAGE OVERRIDE
page:Label(" Damage Override ")
page:Toggle("頭部傷害覆蓋", false, function(v) Flags.HDmgOvr = v end)
page:Slider("Head Min Damage", 1, 100, 80, function(v) Flags.HDmgMin = v end)
page:Toggle("身體傷害覆蓋", false, function(v) Flags.BDmgOvr = v end)
page:Slider("Body Min Damage", 1, 100, 20, function(v) Flags.BDmgMin = v end)
page:Toggle("僅開鏡時覆蓋", false, function(v) Flags.DmgScopedOnly = v end)
            ...
            pcall(function()
                ...
                if best then
                    ...
                    if Flags.SANBP then
                        ...
                        local bones={"頭部","HumanoidRootPart"}
