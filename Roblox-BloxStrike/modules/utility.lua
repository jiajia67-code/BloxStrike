...
M:Label("  Bunny Hop ")
M:Toggle("連跳", false, function(v) Flags.Bhop = v end)
M:Dropdown({Name="連跳模式", Flag="BhopMode", Options={"自動","正常"," HvH","長跳","連跳加強","邊緣蟲","Strafe Hack","體力跳"}, Default="Auto"})
M:Slider("連跳延遲", 0, 100, 0, function(v) Flags.BhopDelay = v end)
M:Slider("連跳速度", 16, 50, 24, function(v) Flags.BhopSpeed = v end)
M:Toggle("連跳僅按鍵", false, function(v) Flags.BhopKeybind = v end)
M:Toggle("連跳自動跑", false, function(v) Flags.BhopAutoRun = v end)
M:Toggle("連跳蹲下", false, function(v) Flags.BhopCrouch = v end)
M:Toggle("連跳跳蟲", false, function(v) Flags.BhopJB = v end)
M:Toggle("連跳邊緣蟲", false, function(v) Flags.BhopEB = v end)
M:Separator()

 -- Air Strafe
M:Label(" Air Strafe ")
M:Toggle("自動旋轉", true, function(v) Flags.BhopStrafe = v end)
M:Dropdown({Name="旋轉模式", Flag="BhopStrafePattern", Options={"線性","正弦波","隨機","進攻","平滑","圓形"}, Default="Linear"})
M:Slider("旋轉速度", 1, 30, 10, function(v) Flags.BhopStrafeSpd = v end)
M:Slider("旋轉角度限制", 10, 90, 45, function(v) Flags.BhopStrafeAngle = v end)
M:Slider("旋轉靈敏度", 1, 20, 8, function(v) Flags.BhopStrafeSens = v end)
M:Toggle("前衝旋轉", false, function(v) Flags.BhopWStrafe = v end)
M:Toggle("空中加速", false, function(v) Flags.BhopAirAccel = v end)
M:Slider("Air Accel Value", 1, 20, 10, function(v) Flags.BhopAirAccelVal = v end)
M:Separator()

 -- Ground Strafe
-- M:Label(" Ground Strafe ")
-- M:Toggle("地面旋轉", false, function(v) Flags.BhopGround = v end)
-- M:Slider("Ground Strafe Speed", 1, 20, 10, function(v) Flags.BhopGroundSpd = v end)
-- M:Dropdown({Name="地面模式", Flag="BhopGroundPattern", Options={"左","右","Zigzag","Wiggle"}, Default="Left"})
-- M:Toggle("預旋轉", false, function(v) Flags.BhopPreStr = v end)
...
M:Separator()
 ...
 -- Advanced
M:Label(" Advanced ")
M:Toggle("多段跳", false, function(v) Flags.BhopMultiJump = v end)
M:Slider("Multi-Jump Count", 2, 5, 2, function(v) Flags.BhopMultiCount = v end)
-- M:Toggle("體力系統", false, function(v) Flags.BhopStamina = v end)
...
-- M:Toggle("連跳音效", false, function(v) Flags.BhopSound = v end)
-- M:Toggle("速度指示器", false, function(v) Flags.BhopSpeedInd = v end)
M:Toggle("連跳綁定(空白鍵)", false, function(v) Flags.BhopBindSpace = v end)
M:Toggle("連跳自動旋轉按鍵", false, function(v) Flags.BhopAutoKeys = v end)
...
-- M:Toggle("命中標記", false, function(v) Flags.HitMarker = v end)
-- M:Toggle("自動十字準星", false, function(v) Flags.AutoCrosshair = v end)
-- M:Toggle("傷害數字", false, function(v) Flags.DamageNumbers = v end)
M:Toggle("玩家數顯示", false, function(v) Flags.PlayerCount = v end)
M:Button({Name="錄製精彩片段", Color=Color3.fromRGB(140,60,60)}, function()
    pcall(function() StarterGui:SetCore("ToggleRecording", {}) end)
end)
M:Separator()

-- 4. KILL EFFECTS v2.0 (30+ sounds, 15+ effects)

-- M:Label("  Kill Sounds (20 styles) ")
-- M:Toggle("擊殺音效", false, function(v) Flags.FxKillSound = v end)
...
M:Toggle("隨機俯仰", false, function(v) Flags.FxRandomPitch = v end)
M:Separator()

-- M:Label("  Hit & Death Sounds ")
-- M:Toggle("命中音效", false, function(v) Flags.FxHitSound = v end)
M:Dropdown({Name="命中音效風格", Flag="FxHitSoundIdx", Options={"1","2","3","4","5","6","7","8"}, Default="1"})
M:Separator()

-- M:Label("  Screen Effects ")
-- M:Toggle("畫面閃光", false, function(v) Flags.FXFlash = v end)
-- M:Toggle("白色閃光", false, function(v) Flags.FxWhiteFlash = v end)
-- M:Toggle("紅色閃光", false, function(v) Flags.FxRedFlash = v end)
-- M:Toggle("模糊閃光", false, function(v) Flags.FXBlur = v end)
-- M:Toggle("色彩校正", false, function(v) Flags.FXColorFlash = v end)
-- M:Toggle("泛光閃光", false, function(v) Flags.FXBloom = v end)
-- M:Toggle("太陽光線閃光", false, function(v) Flags.FXSunRays = v end)
M:Toggle("畫面震動", false, function(v) Flags.FXShake = v end)
M:Separator()

-- M:Label("  Visual Effects ")
-- M:Toggle("色差效果", false, function(v) Flags.FXChromatic = v end)
-- M:Toggle("暗角 (紅邊)", false, function(v) Flags.FXVignette = v end)
-- M:Toggle("血液粒子", false, function(v) Flags.FxBlood = v end)
-- M:Toggle("擊殺擴散圈", false, function(v) Flags.FxKillRing = v end)
-- M:Toggle("去飽和度 (CS2)", false, function(v) Flags.FxDesat = v end)
-- M:Toggle("視野衝擊", false, function(v) Flags.FxFovPunch = v end)
-- M:Toggle("故障線條", false, function(v) Flags.FxGlitch = v end)
-- M:Toggle("慢動作視野", false, function(v) Flags.FXSlowMo = v end)
M:Toggle("傷害方向", false, function(v) Flags.FXDamageDir = v end)
M:Separator()

-- M:Label("  Kill Streak ")
-- M:Toggle("連殺音效", false, function(v) Flags.FxStreakSound = v end)
-- M:Toggle("連殺文字", false, function(v) Flags.FxStreakText = v end)
-- M:Label("2x Double | 3x Triple | 4x Quad | 5x Penta")
M:Label("7x Unstoppable | 10x Rampage | 15x GODLIKE")
M:Separator()

-- M:Label("  Kill Feed ")
-- M:Toggle("擊殺訊息覆蓋", false, function(v) Flags.FxKillFeed = v end)
...
if not U then U = M end  -- fallback to same tab
 ...
 -- BOMB TIMER
-- U:Label("  Bomb Timer ")
-- U:Toggle("炸彈計時器", false, function(v) Flags.BombTimer = v end)
...
task.spawn(function()
 ...
 -- AUTO DEFUSE
-- U:Label("  Bomb ")
-- U:Toggle("自動拆彈", false, function(v) Flags.AutoDefuse = v end)
-- U:Slider("Defuse Range", 3, 10, 5, function(v) Flags.DefuseRange = v end)
-- U:Toggle("自動放彈", false, function(v) Flags.AutoPlant = v end)
...
pcall(function()
 ...
 -- SERVER
-- U:Label("  Server ")
-- U:Toggle("自動重連", false, function(v) Flags.AutoReconnect = v end)
