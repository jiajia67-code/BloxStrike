            ...
            for i = 1, maxT do
                ...
                if t then
                    if Flags.KA_Rotate then
                        local dir = (t.E.HRP.Position - myHrp.Position).Unit
...
-- ═══ 24. Auto Tool (switch to best tool) ═══
...
-- ═══ 29. Blade ESP (show weapon range) ═══
...
print("[World] Module loaded (25 features)")
...
local SHOP = {
    Blocks = {
        {item = "wool_white", cost = 4, res = "iron"},
        {item = "stone", cost = 12, res = "iron"},
        {item = "obsidian", cost = 12, res = "emerald"},
        {item = "end_stone", cost = 8, res = "diamond"},
    },
    Swords = {
        {item = "wood_sword", cost = 10, res = "iron"},
        {item = "stone_sword", cost = 20, res = "iron"},
        {item = "iron_sword", cost = 75, res = "iron"},
        {item = "diamond_sword", cost = 4, res = "emerald"},
        {item = "emerald_sword", cost = 12, res = "emerald"},
    },
    Armor = {
        {item = "chainmail_chestplate", cost = 40, res = "iron"},
        {item = "iron_chestplate", cost = 80, res = "iron"},
        {item = "diamond_chestplate", cost = 8, res = "diamond"},
    },
    Tools = {
        {item = "wood_axe", cost = 10, res = "iron"},
        {item = "iron_pickaxe", cost = 60, res = "iron"},
        {item = "diamond_pickaxe", cost = 6, res = "diamond"},
    },
}
...
print("[Shop] Module loaded (15 features)")
