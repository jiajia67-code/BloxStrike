--!nocheck
-- ═══════════════════════════════════════════════════════════════
-- BED WARS ULTIMATE v5.1 (CatVape-style APIs)
-- Built: 2026-08-27 10:08:45
-- ═══════════════════════════════════════════════════════════════
...
(function()
    print('═══════════════════════════════════════════════')
    print('  ⚔️ BED WARS ULTIMATE v5.1 (CatVape-style)')
    ...
    -- Create UI
    local ui = createUI(bw, flags, api)
    ...
    if bw.isMobile then
        print('  📱 Mobile mode — Tap X to toggle UI')
    else
        print('  🖥️ PC mode — Press RightAlt to toggle UI')
    end
    print('═══════════════════════════════════════════════')
end)()