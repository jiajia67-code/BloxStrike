--!nocheck
-- BedWars Ultimate v5.0 (CatVape-style APIs)
-- Built: 2026-08-27 10:05:54
-- Modules: 12


-- ══════ CORE ══════
local core_module = (function(BW, Flags, UI, api)
--!nocheck
-- ═══════════════════════════════════════════════════════════════
...
-- ═══ Cleanup ═══
function BW:Cleanup()
    for _, conn in pairs(BW.Connections) do
        pcall(function() conn:Disconnect() end)
    end
    table.clear(BW.Connections)

    -- Clean ESP objects
    for _, bb in pairs(BW.ESP_BBs) do
        pcall(function() bb:Destroy() end)
    end
    table.clear(BW.ESP_BBs)
...
-- ══════ API ══════
local api_module = (function(BW, Flags, UI, api)
--!nocheck
-- ═══════════════════════════════════════════════════════════════
...
-- ══════ UI ══════
local ui_module = (function(BW, Flags, UI, api)
-- ══════════════════════════════════════════════════════════════
...
-- ══════ COMBAT ══════
local combat_module = (function(BW, Flags, UI, api)
--!nocheck
-- ═══════════════════════════════════════════════════════════════
...
-- ══════ WORLD ══════
local world_module = (function(BW, Flags, UI, api)
--!nocheck
-- ═══════════════════════════════════════════════════════════════
...
-- ══════ ESP ══════
local esp_module = (function(BW, Flags, UI, api)
-- ══════════════════════════════════════════════════════════════
-- ESP MODULE
-- ══════════════════════════════════════════════════════════════
...
-- ══════ MOVE ══════
local move_module = (function(BW, Flags, UI, api)
-- ══════════════════════════════════════════════════════════════
-- MOVEMENT MODULE
-- ══════════════════════════════════════════════════════════════
...
-- ══════ SHOP ══════
local shop_module = (function(BW, Flags, UI, api)
--!nocheck
-- ═══════════════════════════════════════════════════════════════
...
-- ══════ UTIL ══════
local util_module = (function(BW, Flags, UI, api)
-- ══════════════════════════════════════════════════════════════
-- UTILITY MODULE
-- ══════════════════════════════════════════════════════════════
...
-- ══════ LEGIT ══════
local legit_module = (function(BW, Flags, UI, api)
-- ══════════════════════════════════════════════════════════════
-- LEGIT MODULE
-- ══════════════════════════════════════════════════════════════
...
-- ══════ AUTOLOAD ══════
local autoload_module = (function(BW, Flags, UI, api)
-- ══════════════════════════════════════════════════════════════
...
-- ══════ EVENTS ══════
local events_module = (function(BW, Flags, UI, api)
-- ══════════════════════════════════════════════════════════════
...
-- ══════ INITIALIZATION ══════
(function()
    local BW = core_module()
    local Flags = BW.Flags
    
    -- Load API bridge
    local api_success, api = pcall(function()
        return require(game:GetService('ReplicatedStorage')) -- placeholder
    end)
    ...
    -- Create UI
    local UI = ui_module(BW, Flags, nil, api)
    
    -- Load all modules
    local modules = {
        'combat', 'world', 'esp', 'move', 'shop', 'util', 'legit', 'autoload', 'events'
    }
    
    for _, name in pairs(modules) do
        local mod = _G[name .. '_module']
        if mod then
            pcall(function() mod(BW, Flags, UI, api) end)
        end
    end
    
    print('═══════════════════════════════════════')
    print('  BED WARS ULTIMATE v5.0 (CatVape-style)')
    print('  Loaded! Press RightAlt to toggle UI')
    print('═══════════════════════════════════════')
end)()