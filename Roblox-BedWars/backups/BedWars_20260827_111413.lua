...
-- ═══════════════════════════════════════════════════════════════
    ...
    BW.Win:Tab("Combat")
    BW.Win:Toggle("Sprint", false, function(v)
        Flags.Sprint = v
        if v then
    ...
    -- ═══ Kill Aura ═══
    BW.Win:Toggle("Kill Aura", false, function(v) Flags.KA = v end, "Combat", "Auto attack nearest enemy")
    BW.Win:Slider("KA Range", 5, 20, 18, function(v) Flags.KA_Range = v end, "Combat")
    BW.Win:Slider("KA Speed", 1, 20, 12, function(v) Flags.KA_Speed = v end, "Combat")
    BW.Win:Toggle("KA Auto Swing", true, function(v) Flags.KA_Swing = v end, "Combat")
    BW.Win:Toggle("KA Rotate", false, function(v) Flags.KA_Rotate = v end, "Combat", "Rotate to face target")
    BW.Win:Toggle("KA Multi", false, function(v) Flags.KA_Multi = v end, "Combat", "Attack multiple targets")
    ...
    -- ═══ Crystal Aura ═══
    BW.Win:Toggle("Crystal Aura", false, function(v) Flags.CA = v end, "Combat", "Auto place & break crystals")
    BW.Win:Slider("CA Range", 3, 15, 8, function(v) Flags.CA_Range = v end, "Combat")
    BW.Win:Slider("CA Delay", 0, 200, 50, function(v) Flags.CA_Delay = v / 1000 end, "Combat")
    BW.Win:Toggle("CA Auto Break", true, function(v) Flags.CA_Break = v end, "Combat")
    ...
    -- ═══ Auto Clicker ═══
    BW.Win:Toggle("Auto Click", false, function(v) Flags.AutoClick = v end, "Combat", "Auto click attack")
    BW.Win:Slider("Click CPS", 5, 20, 14, function(v) Flags.ClickCPS = v end, "Combat")
    ...
    -- ═══ Silent Aim ═══
    BW.Win:Toggle("Silent Aim", false, function(v) Flags.SilentAim = v end, "Combat", "Silent aimbot (no visual)")
    BW.Win:Slider("SA FOV", 10, 180, 90, function(v) Flags.SA_FOV = v end, "Combat")
    BW.Win:Toggle("SA Headshot", false, function(v) Flags.SA_Head = v end, "Combat")
    BW.Win:Toggle("SA Wall Check", true, function(v) Flags.SA_Wall = v end, "Combat")

    -- ═══ Trigger Bot ═══
    BW.Win:Toggle("Trigger Bot", false, function(v) Flags.TriggerBot = v end, "Combat", "Auto shoot when aimed at enemy")
    ...
    -- ═══ Auto Release (Bow) ═══
    BW.Win:Toggle("Auto Release", false, function(v) Flags.AutoRelease = v end, "Combat", "Auto release bow")
    BW.Win:Slider("Release %", 10, 100, 80, function(v) Flags.ReleasePercent = v end, "Combat")

    -- ═══ Projectile Aimbot ═══
    BW.Win:Toggle("Proj Aimbot", false, function(v) Flags.ProjAim = v end, "Combat", "Predictive aim for projectiles")
    BW.Win:Slider("Proj FOV", 10, 180, 60, function(v) Flags.ProjFOV = v end, "Combat")
...
-- ═══════════════════════════════════════════════════════════════
    ...
    BW.Win:Tab("World")
    BW.Win:Toggle("Scaffold", false, function(v) Flags.Scaffold = v end, "World", "Auto place blocks under you")
    BW.Win:Toggle("Scaffold Down", false, function(v) Flags.ScaffoldDown = v end, "World", "Place blocks downward")
    BW.Win:Slider("Scaffold Width", 1, 3, 1, function(v) Flags.ScaffoldWidth = v end, "World")
    BW.Win:Toggle("Scaffold Tower", false, function(v) Flags.ScaffoldTower = v end, "World", "Tower mode (hold space)")
    BW.Win:Toggle("Scaffold Safe", true, function(v) Flags.ScaffoldSafe = v end, "World", "Extra safety checks")
    ...
    -- ═══ Bed Protector ═══
    BW.Win:Toggle("Bed Protect", false, function(v) Flags.BedProtect = v end, "World", "Auto place blocks around bed")
    BW.Win:Slider("BP Layers", 1, 3, 2, function(v) Flags.BPLayers = v end, "World")
    ...
    -- ═══ Auto Collect ═══
    BW.Win:Toggle("Auto Collect", false, function(v) Flags.AutoCollect = v end, "World", "Auto collect resources")
    BW.Win:Slider("Collect Range", 5, 50, 15, function(v) Flags.CollectRange = v end, "World")
    BW.Win:Toggle("Collect Iron", true, function(v) Flags.CollectIron = v end, "World")
    BW.Win:Toggle("Collect Gold", true, function(v) Flags.CollectGold = v end, "World")
    BW.Win:Toggle("Collect Diamond", true, function(v) Flags.CollectDiamond = v end, "World")
    BW.Win:Toggle("Collect Emerald", true, function(v) Flags.CollectEmerald = v end, "World")
    ...
    -- ═══ Auto Break Bed ═══
    BW.Win:Toggle("Auto Break Bed", false, function(v) Flags.AutoBreakBed = v end, "World", "Auto break enemy beds")
    ...
    -- ═══ Nuker ═══
    BW.Win:Toggle("Nuker", false, function(v) Flags.Nuker = v end, "World", "Auto break blocks around you")
    BW.Win:Slider("Nuker Range", 3, 10, 5, function(v) Flags.NukerRange = v end, "World")
    ...
    -- ═══ Chest Steal ═══
    BW.Win:Toggle("Chest Steal", false, function(v) Flags.ChestSteal = v end, "World", "Auto take items from chests")

    -- ═══ Safe Walk ═══
    BW.Win:Toggle("Safe Walk", false, function(v) Flags.SafeWalk = v end, "World", "Prevent falling off edges")

    -- ═══ Xray ═══
    BW.Win:Toggle("Xray", false, function(v) Flags.Xray = v end, "World", "See ores through walls")
...
-- ═══════════════════════════════════════════════════════════════
    ...
    -- ═══ Auto Buy ═══
    BW.Win:Tab("Shop")
    BW.Win:Toggle("Auto Buy Blocks", false, function(v) Flags.AutoBuyBlocks = v end, "Shop", "Auto buy blocks")
    BW.Win:Toggle("Auto Buy Sword", false, function(v) Flags.AutoBuySword = v end, "Shop", "Auto buy best sword")
    BW.Win:Toggle("Auto Buy Armor", false, function(v) Flags.AutoBuyArmor = v end, "Shop", "Auto buy best armor")
    BW.Win:Toggle("Auto Buy Tools", false, function(v) Flags.AutoBuyTools = v end, "Shop", "Auto buy best tools")
    BW.Win:Toggle("Auto Buy Projectiles", false, function(v) Flags.AutoBuyProj = v end, "Shop", "Auto buy projectiles")
    BW.Win:Slider("Buy Delay", 100, 2000, 500, function(v) Flags.BuyDelay = v end, "Shop")

    -- ═══ Shop Tier Bypass ═══
    BW.Win:Toggle("Tier Bypass", false, function(v) Flags.ShopTierBypass = v end, "Shop", "Access higher shop tiers")
